				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between h-16">
						...
						<div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
							...
							<button onClick={logout} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
								Sign out
							</button>
						</div>
					</div>
								...
								<div className="p-6 bg-white border-b border-gray-200">
									...
									<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
										...
										<div className="bg-green-50 p-6 rounded-lg">
											...
											<div className="mt-4">
												<Link href="/settings" className="text-green-600 hover:text-green-800 font-medium">
													Go to Settings →
												</Link>
											</div>
										</div>
										...
										<div className="bg-purple-50 p-6 rounded-lg">
											...
											<div className="mt-4">
												<Link href="/actions" className="text-purple-600 hover:text-purple-800 font-medium">
													View Actions →
												</Link>
											</div>
										</div>
