                ...
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors text-left ${
                      activeTab === tab.id
                        ? 'text-[#037764] bg-[#037764]/10 font-medium'
                        : 'text-gray-700 hover:text-[#037764] hover:bg-gray-50'
                    }`}
                  >
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#037764] focus:border-transparent"
                          defaultValue="Demo"
                        />
                      </div>
                      <div>
                    ...
                    <div className="pt-4">
                      <button className="bg-[#037764] text-white px-6 py-2 rounded-md hover:bg-[#025a4a] transition-colors">
                        Save Changes
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-t border-gray-200 pt-6">
                      ...
                      <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        ...
                        <button className="bg-[#037764] text-white px-4 py-2 rounded-md hover:bg-[#025a4a] transition-colors text-sm">
                          Enable
                        </button>
                      </div>
                    </div>
