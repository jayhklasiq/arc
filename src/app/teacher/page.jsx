				...
				<div className="bg-gradient-to-r from-[#037764] to-[#025a4a] rounded-xl p-6 mb-8 text-white">
					<div className="flex items-center justify-between">
						<div>
							...
							<p className="text-[#F9FEFA]/90">"Personalized learning isn't about technology—it's about understanding each student's unique journey and adapting accordingly."</p>
						</div>
						...
						<div className="space-y-3">
							...
							<div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
								<div>
									...
									<p className="text-sm text-gray-600">Attendance rate: 95%</p>
								</div>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
						...
						<div className="space-y-3">
							...
							<div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
								...
								<span className="px-2 py-1 bg-gray-100 text-gray-800 text-xs font-medium rounded-full">Draft</span>
							</div>
						</div>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
						...
						<div className="space-y-3">
							<div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
								...
								<span className="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">Overdue</span>
							</div>
							...
							<div className="flex items-center justify-between p-3 bg-[#FED703]/10 rounded-lg">
								...
								<span className="px-2 py-1 bg-[#FED703]/20 text-yellow-800 text-xs font-medium rounded-full">Pending</span>
							</div>
							...
							<div className="flex items-center justify-between p-3 bg-[#037764]/10 rounded-lg">
								...
								<span className="px-2 py-1 bg-[#037764]/20 text-[#037764] text-xs font-medium rounded-full">Upcoming</span>
							</div>
						</div>

						<div className="flex space-x-2 mt-4">
							<button className="flex-1 bg-[#037764] text-white py-2 rounded-lg hover:bg-[#025a4a] transition-colors font-medium">Grade Now</button>
							<button className="flex-1 border border-[#037764] text-[#037764] py-2 rounded-lg hover:bg-[#037764]/5 transition-colors font-medium">Send Reminders</button>
						</div>
					</div>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
						...
						<div className="space-y-4">
							...
							<div className="flex items-center justify-between">
								...
								<span className="text-sm font-medium text-[#037764]">15 students</span>
							</div>
							<div className="w-full bg-gray-200 rounded-full h-2">
								<div className="bg-[#037764] h-2 rounded-full" style={{ width: "54%" }}></div>
							</div>
